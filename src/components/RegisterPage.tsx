...
function generateStrongPassword(length = 16) {
    ...
    const remaining = Array.from({ length: Math.max(4, length) - required.length }, () => pick(all));
...
export default function RegisterPage({ onBack, onSuccess }: RegisterPageProps) {
    ...
    const handleSuggestPassword = () => {
        ...
        toast.success('Strong password generated and revealed');
    };
    ...
    return (
        ...
        >
            ...
            {/* Header */}
            <div className="glass-card relative z-10 px-4 py-2 border-b border-glass-border flex-shrink-0">                <div className="flex items-center justify-between">
                            ...
                            >
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        className={`pl-10 pr-20 bg-input-background border-glass-border focus:border-neon-purple/50 focus:ring-neon-purple/20 ${
                                    ...
                                    <div className="flex items-center justify-between gap-3">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <Button
                                                ...
                                                title="Suggest a strong password and reveal it"
                                            >
